...
class TestValidateTrackerPath:
    ...
    def test_valid_tracker_path(self):
        ...
        assert validate_tracker_path("trackers/2026-02-05-amazon.md") == "trackers/2026-02-05-amazon.md"
...
class TestValidateTrackerStatus:
    ...
    def test_valid_tracker_statuses(self):
        ...
        valid_statuses = ["Reviewed", "Resume Written", "Applied", "Interview", "Offer", "Rejected", "Ghosted"]
        for status in valid_statuses:
